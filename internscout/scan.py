...
from internscout.sources import bestjobs, ejobs, hipo, juniors, nofluffjobs, simplify, stagiipebune, undelucram
...
def scan(http: HttpClient | None = None) -> list[Job]:
    ...
    aggregators = [
        ...
        ("Juniors.ro", "juniors", juniors.fetch_jobs, True, False),
