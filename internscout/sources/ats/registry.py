...
from internscout.sources.ats import amazon, apple, ashby, bamboohr, breezy, careers, comeet
from internscout.sources.ats import eightfold, freshteam, google, greenhouse, icims, jazzhr, jobsoid, join
from internscout.sources.ats import lever, meta, microsoft, personio, pinpoint, recruitee, rippling
from internscout.sources.ats import smartrecruiters, softgarden, successfactors, teamtailor, workday
from internscout.sources.ats import workable
